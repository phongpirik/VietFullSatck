    ...
    function qa_poll_answer_render($poll_id, $is_multi_choice) {
        ...
        <div class="buttons">
            ...
            <span class="items-text">
                <?php
                    printf( __('By submit your answer, you agree to the <a target="_blank" href="%s">privacy policy</a> and <a target="_blank" href="%s">terms of service.</a>', ET_DOMAIN), et_get_page_link('term'), et_get_page_link('term') );
                ?>
            </a></span>
        </div>
        <?php
    ...
    function qa_poll_submit_form() {
        ...
        <form id="submit_poll" class="form_submit_poll">
            ...
            <div class="btn-more-anwser">
                <span class="btn-add-more"><i class="fa fa-plus"></i>More answer</span>
            ...
            <div class="chose-date">
                <div class='input-group date' id='datetimepicker5'>
                    <input type='text' name="poll_end_date" class="form-control form-group" placeholder="End day" />
