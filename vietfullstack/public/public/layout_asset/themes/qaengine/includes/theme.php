...
class QA_Engine extends AE_Base{
	...
	function save_post_meta_backend ($post_ID, $post){
		update_post_meta($post_ID, 'et_pump_time', time());
		update_post_meta($post_ID, 'et_vote_count', 0);
		update_post_meta($post_ID, 'et_view_count', 0);
		update_post_meta($post_ID, 'et_users_follow', 0);
		update_post_meta($post_ID, 'et_new_post', 0);
		update_post_meta($post_ID, 'et_answers_count', 0);
	}
	/**
